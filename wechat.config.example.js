...
module.exports = {
   ...
   * endWord:每日说内容的最后的落款 案例中效果为‘——————————爱你的老公Jason’
   * date:每天定时的发送时间，案例中代表每天早上8点钟，具体规则见‘wechaty/lib/index.js’ (多个好友不要设置相同时间！不要设置相同时间！不要设置相同时间！)
   */ 
  DAYLIST: [
    {name:'星星',alias:'小仙女',memorialDay:'2017/01/19',city:'深圳',endWord:'爱你的老公Jason',date:'0 0 10 * * *'},
  ],
   ...
   */
  ROOMJOINLIST: [
    {name:'深圳-闲聊',welcome:'有什么问题都可以群里提出，大家都是很热情的'}
  ],
  /**
   * 关键词回复列表
   ...
   */ 
  KEYWORDLIST:[
    {key:['你好','您好','你是谁'],reply:'你好啊，我是森小星1号'}
  ],
  /**
   * 新通过好友，默认发送消息
   */
  ...
  EVENTKEYWORDLIST:[
    ...
    {key:'我要国旗',position:'middle',event:'avatar'},
    {key:'表情包',positon:'start',event:'emo'},
    {key:'kkzp',positon:'satrt',event:'meinv'},
  ],  
}