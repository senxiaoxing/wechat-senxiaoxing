...
module.exports = {
   ...
   */ 
  DAYLIST: [
    {name:'昵称',alias:'备注',memorialDay:'2015/04/18',city:'上海',endWord:'爱你的朋友jasonyang',date:'0 0 8 * * *'},
  ],
   ...
   */
  ROOMLIST: [
    {roomName:'群名',sortId:22,endWord:'森小星',date:'0 30 7 * * *'},
  ],
   /**
   ...
   * reply: 回复内容
   */ 
  KEYWORDLIST:[{key:['你好','您好'],reply:'你好啊，我是森小星1号'}],
  /**
   * 新通过好友，默认发送消息
   */
